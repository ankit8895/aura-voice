...
export const generationsRouter = createTRPCRouter({
  ...
  create: orgProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      if (!voice)
        throw new TRPCError({ code: "NOT_FOUND", message: "Voices not found" });
      ...
      let r20ObjectKey: string | null = null;
      ...
      try {
        ...
        r20ObjectKey = `generations/orgs/${ctx.orgId}/${generation.id}`;

        await uploadAudio({ buffer, key: r20ObjectKey });
